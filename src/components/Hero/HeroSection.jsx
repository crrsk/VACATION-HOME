  ...
  return (
    <section id="inicio" className="hero-section" aria-labelledby="hero-title">
      ...
      <p className="hero-copy">
        Villas y apartamentos seleccionados para viajeros que valoran diseño, comodidad
        y experiencias memorables en cada detalle.
      </p>

      <div className="hero-actions">
        <button className="button-primary" type="button">Explorar alojamientos</button>
        <button className="button-secondary" type="button">Hablar con asesor</button>
      </div>

      <div className="hero-metrics" aria-label="Métricas de confianza">
        <article>
          <strong>4.9/5</strong>
